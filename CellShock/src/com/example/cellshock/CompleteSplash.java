//Splash Screen Acitivity for when a level has been compeleted
...
public class CompleteSplash extends ActionBarActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
	...
	editor.putInt("levelUnlock", currentLevel+1);
	editor.commit();
